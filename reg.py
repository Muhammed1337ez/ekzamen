...
username_entry = Entry(user_frame, bg="red")
...
password_entry = Entry(user_frame, bg="red")
...
email_entry = Entry(user_frame, bg="red", width=45)
...
age_entry = Spinbox(user_frame, bg="red", from_=0, to=20)
...
phone_entry = Entry(user_frame, bg="red")
